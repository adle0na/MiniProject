...
public class WeaponSwitchSystem : MonoBehaviour
{
    ...
    [SerializeField] private WeaponBase[] weapons; // 소지중인 무기 종류
    ...
    private void Awake()
    {
        ...
        // Handgun을 가장 처음에 사용하는 무기로 설정
        SwitchingWeapon(WeaponType.HandGun);
    }
    ...
    private void UpdateSwitch()
    {
        ...
        // 1~?(개수 만큼) 숫자키를 누르면 무기 교체
        int inputIndex = 0;
        if (int.TryParse(Input.inputString, out inputIndex) && inputIndex > 0 && inputIndex < 6)
        {
